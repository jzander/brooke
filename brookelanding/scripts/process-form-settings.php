 ...
 */
   ...
   $email_recipient     = "info@caliaquariums.com";
 ...
 */
   ...
   $forward_user        = TRUE;
   $final_destination   = "../contactconfirm.html";
 ...
 */
   ...
   $subject_field       = "require-subject";  // If your subject is defined in your form put the field name here.
 ...
 */
   ...
   $from_name_field      = "require-your-name";   // If your from name is defined in your form put the field name here
 ...
 */
   ...
   $from_email_field    = "require-your-email";   // If your from email address is defined in your form put the field name here
